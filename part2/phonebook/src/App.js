...
const App = () => {
  ...
  const addPerson = event => {
    ...
    if (
      ...
      if (
        window.confirm(
          `${personObject.name} already exists in the directory. Do you want to replace the old number?`
        )
      ) {
        ...
        setErrorMessage(`The number for ${personObject.name} has been modified`);
        setNewName("");
        setNewNumber("");
        setTimeout(() => {
          setErrorMessage(null);
